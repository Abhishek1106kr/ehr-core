...
import { Monitor, ArrowLeft, ExternalLink, Activity, ScrollText, Database, MousePointerClick, Workflow, Users, Calendar } from "lucide-react";
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-2xl">
              Explore the user interfaces, dashboards, monitoring timeline, and compliance tools built into OpenEHR Bridge.
            </p>
          </div>

          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {screenshots.map((item, index) => (
              <Card key={index} className="group flex flex-col justify-between overflow-hidden transition-all hover:border-primary/50 hover:shadow-md">
                <div>
