        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-2xl">
              Complete architectural specs, developer guides, REST API reference, and production deployment checklists.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Card className="flex flex-col justify-between transition-all hover:border-primary/50">
              <CardHeader>
                ...
                <CardDescription>
                  Step-by-step instructions for patient intake, scheduling, insurance checks, and monitoring.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="flex flex-col justify-between transition-all hover:border-primary/50">
              <CardHeader>
                ...
                <CardDescription>
                  Monorepo architecture, Prisma schemas, BullMQ queue engines, and Playwright drivers.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild variant="outline" size="sm" className="w-full gap-1.5">
            ...
            <Card className="flex flex-col justify-between transition-all hover:border-primary/50">
              <CardHeader>
                ...
                <CardDescription>
                  REST endpoints, FHIR R4 resources, auth endpoints, metrics, and Swagger OpenAPI specs.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild variant="outline" size="sm" className="w-full gap-1.5">
            ...
            <Card className="flex flex-col justify-between transition-all hover:border-primary/50">
              <CardHeader>
                ...
                <CardDescription>
                  Step-by-step production deployment instructions for Railway, Docker, and environment configs.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild variant="outline" size="sm" className="w-full gap-1.5">
