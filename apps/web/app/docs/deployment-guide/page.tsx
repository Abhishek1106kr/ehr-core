      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <Badge className="bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-0">Railway Ready</Badge>
          </div>
          <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl">
            Railway & Cloud Deployment Guide
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Complete deployment instructions for Railway, multi-stage Docker builds, PostgreSQL, Redis, and environment variables.
          </p>
          ...
          <div className="mt-8 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="text-xs text-muted-foreground space-y-3 leading-relaxed">
                <p>
                  OpenEHR Bridge includes a pre-configured <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-foreground">railway.json</code> configuration file at the repository root.
                </p>
                ...
                <div className="rounded-lg border border-border overflow-hidden">
                  ...
                  <div className="divide-y divide-border font-mono text-[11px]">
                    <div className="p-3 grid grid-cols-3">
                      ...
                      <span className="font-sans text-muted-foreground">Sets Node runtime to production mode.</span>
                    </div>
                    <div className="p-3 grid grid-cols-3">
                      <span className="font-bold text-primary">PORT</span>
                      <span>4000</span>
                      <span className="font-sans text-muted-foreground">Express API listening port.</span>
                    </div>
                    <div className="p-3 grid grid-cols-3">
                      <span className="font-bold text-primary">DATABASE_URL</span>
                      <span>postgresql://...</span>
                      <span className="font-sans text-muted-foreground">Railway Managed PostgreSQL connection string.</span>
                    </div>
                    <div className="p-3 grid grid-cols-3">
                      <span className="font-bold text-primary">REDIS_URL</span>
                      <span>redis://...</span>
                      <span className="font-sans text-muted-foreground">Railway Managed Redis instance URL for BullMQ.</span>
                    </div>
                    <div className="p-3 grid grid-cols-3">
                      <span className="font-bold text-primary">JWT_SECRET</span>
                      <span>&lt;min-32-chars-secret&gt;</span>
                      <span className="font-sans text-muted-foreground">Cryptographic secret for signing JWT tokens.</span>
                    </div>
                    <div className="p-3 grid grid-cols-3">
                      <span className="font-bold text-primary">COOKIE_SECURE</span>
                      <span>true</span>
                      <span className="font-sans text-muted-foreground">Enforces TLS/HTTPS for session cookies.</span>
                    </div>
                    <div className="p-3 grid grid-cols-3">
                      <span className="font-bold text-primary">WEB_ORIGIN</span>
                      <span>https://app.yourdomain.com</span>
                      <span className="font-sans text-muted-foreground">Allowed CORS client origin for cookies.</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-xs text-muted-foreground space-y-3 leading-relaxed">
                <p>
                  Configure Railway&apos;s Health Check Path to <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-foreground">/health</code> on port <code className="font-mono text-foreground">4000</code>.
                </p>
                <div className="bg-muted p-3 rounded-lg font-mono text-foreground">
                  GET /health -&gt; 200 OK &#123; &quot;status&quot;: &quot;ok&quot;, &quot;service&quot;: &quot;openehr-bridge-api&quot; &#125;
                </div>
                <div className="flex items-start gap-2 text-amber-600 dark:text-amber-400 bg-amber-500/10 p-3 rounded-lg border border-amber-500/20">
                  ...
                  <span>
                    Note: Ensure <code className="font-mono">npx prisma db push</code> or migrations run before starting the Express container.
                  </span>
                </div>
              </CardContent>
            </Card>
