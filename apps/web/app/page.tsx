      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h1 className="mt-6 max-w-4xl text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-6xl lg:leading-[1.15]">
                Bridge AI Agents with <span className="text-primary">FHIR R4 Standards</span> & Legacy EHR Portals
              </h1>

              {/* Subtitle / Pitch */}
              <p className="mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed sm:text-xl">
                OpenEHR Bridge provides a unified abstraction layer that connects modern AI workflows directly to healthcare infrastructure — supporting both modern FHIR R4 APIs and legacy web EHRs via automated browser execution.
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                ...
                <Button size="lg" variant="ghost" asChild className="gap-2 px-6 text-muted-foreground">
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-base text-muted-foreground">
                Engineered for maximum reliability and interoperability across modern APIs and legacy hospital software.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Orchestrates autonomous clinical intake, patient lookup, and appointment booking.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> Zod schema parsing, structured action dispatch, BullMQ job queues, exponential retries.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                ...
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> Maps Patient, Practitioner, Appointment, Coverage resources with spec validation.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                ...
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> Step-by-step visual screenshot audit trail, DOM selector recovery, transient retry simulation.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Real-time eligibility verification checking member status, copay, and deductible details.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> Automated clearinghouse integration, EDI 270/271 status checks, coverage breakdown caching.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Conversational audio intake processing transcribing speech to structured JSON records.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> Multimodal speech-to-text pipeline, entity extraction, prompt safety validation.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Automated document OCR extracting patient IDs, insurance cards, and medical histories.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> Image pre-processing, structured data extraction, PII masking algorithms.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Append-only audit trail logging actor ID, entity states, timestamps, and trace context.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> State change snapshots (before/after), correlation ID propagation, immutable storage.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Operational dashboard tracking job status, response latencies, and active providers.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> Prometheus metrics endpoint (`/api/v1/metrics`), Pino structured logging, health checks.
                </CardContent>
              </Card>
              ...
              <Card className="flex flex-col justify-between transition-shadow hover:shadow-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Dynamic switcher routing calls between FHIR REST APIs or Playwright browser engines.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-xs text-muted-foreground">
                  <span className="font-semibold text-foreground">Technical Highlights:</span> `chooseIntegrationMode()` evaluation, organizational override rules, resilient circuit breakers.
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section id="workflow" className="py-20 bg-muted/20 border-b border-border/40">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step: "01", title: "Patient Intake", desc: "Voice recording, OCR document scan, or web form submission.", icon: Mic },
                { step: "02", title: "AI Parsing & Safety", desc: "Structured entity extraction with prompt injection defense & PII masking.", icon: Bot },
                { step: "03", title: "Identity Verification", desc: "Aadhaar / National ID validation & confidence score calculation.", icon: ShieldCheck },
                { step: "04", title: "FHIR Mapping", desc: "Conversion of domain model into HL7 FHIR R4 JSON Patient resource.", icon: Database },
                { step: "05", title: "Insurance Check", desc: "Real-time eligibility check for member coverage status & co-pay.", icon: FileText },
                { step: "06", title: "Booking Execution", desc: "Automated dispatch via FHIR REST API or Playwright browser driver.", icon: MousePointerClick },
                { step: "07", title: "Notification", desc: "SMS / email confirmation with idempotency key tracking.", icon: CheckCircle2 },
                { step: "08", title: "Audit & Dashboard", desc: "Append-only audit log entry and real-time dashboard update.", icon: ScrollText },
              ].map((item, idx) => (
                <div
                  key={idx}
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="mt-4 text-base text-muted-foreground leading-relaxed">
                  OpenEHR Bridge isolates background job execution from HTTP web traffic using BullMQ queues, stateful circuit breakers, and spec-compliant FHIR R4 resource mappers.
                </p>
              ...
              <div className="rounded-xl border border-border bg-card p-6 shadow-md">
                <div className="flex items-center gap-2 border-b border-border pb-4">
                  ...
                  <span className="ml-2 font-mono text-xs text-muted-foreground">High-Level Topology</span>
                </div>
                <div className="mt-6 space-y-3 font-mono text-xs">
                  ...
                  <div className="flex items-center justify-between rounded-lg bg-muted p-3">
                    ...
                    <span className="text-muted-foreground">JWT / RBAC / Pino / CircuitBreaker</span>
                  </div>
        ...
        <section className="py-20 bg-muted/20 border-b border-border/40">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "Operations Dashboard", desc: "Real-time metrics, appointment breakdown, and workflow status summary.", href: "/dashboard" },
                { title: "Automation Engine Timeline", desc: "Step-by-step workflow monitoring with live Playwright screenshot evidence.", href: "/automation" },
                { title: "FHIR R4 Resource Explorer", desc: "JSON inspector for synced Patient, Practitioner, and Appointment resources.", href: "/fhir" },
                { title: "Audit Logging System", desc: "Append-only HIPAA & ABDM compliant audit trail with state snapshots.", href: "/audit-logs" },
                { title: "Browser Automation Fallback", desc: "Live Playwright execution logs targeting legacy 2006 hospital portal.", href: "/browser-automation" },
                { title: "System Monitoring & Metrics", desc: "Response latency analytics, active provider status, and health metrics.", href: "/monitoring" },
              ].map((card, i) => (
                <Card key={i} className="group overflow-hidden transition-all hover:border-primary/50 hover:shadow-md">
                  <div className="aspect-video w-full bg-card p-4 border-b border-border flex flex-col justify-center items-center text-center">
                    ...
                    <span className="mt-2 text-xs font-semibold text-muted-foreground">{card.title}</span>
                  </div>
              ...
              <Link href="/docs" className="group">
                <Card className="h-full transition-all group-hover:border-primary">
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">Problem statement, core architecture, and design goals.</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
              <Link href="/docs/developer-guide" className="group">
                <Card className="h-full transition-all group-hover:border-primary">
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">Monorepo setup, environment variables, local testing.</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
              <Link href="/docs/api-reference" className="group">
                <Card className="h-full transition-all group-hover:border-primary">
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">REST endpoints, Swagger OpenAPI specs, and examples.</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
              <Link href="/docs/deployment-guide" className="group">
                <Card className="h-full transition-all group-hover:border-primary">
                  <CardHeader>
                    ...
                    <CardDescription className="text-xs">Step-by-step production deployment & environment guide.</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
            </div>
            ...
            <div className="mt-16 rounded-xl border border-border bg-card p-6 shadow-xs">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2 md:grid-cols-4 text-xs">
                <div>
                  ...
                  <p className="mt-1 text-muted-foreground">Next.js 16 (Turbopack), React 19, Tailwind CSS v4, Shadcn UI, TanStack Query</p>
                </div>
                <div>
                  <p className="font-semibold text-primary">Backend & Database</p>
                  <p className="mt-1 text-muted-foreground">Node.js, Express, TypeScript, Prisma ORM, PostgreSQL 16, Redis 7</p>
                </div>
                <div>
                  <p className="font-semibold text-primary">Automation & Queues</p>
                  <p className="mt-1 text-muted-foreground">BullMQ, Playwright (Headless Chromium), Resilient Circuit Breakers</p>
                </div>
                <div>
                  <p className="font-semibold text-primary">Standards & Security</p>
                  <p className="mt-1 text-muted-foreground">HL7 FHIR R4, JWT Auth, Double-submit CSRF, Pino JSON Logging, Docker</p>
                </div>
              </div>
            </div>
          </div>
